...
<a href="{{ route('author.tags.create')}}" class="btn btn-success mb-2">Create New Tag</a>
<div class="card">
        <div class="card-header fw-bold">List of Tags</div>
        <div class="card-body">
  ...
  <tbody>
    ...
    <a href="{{ route('author.tags.edit', $tag->id)}}" class="btn btn-primary">
    ...
    <form action="{{ route('author.tags.destroy', $tag->id) }}" method="post">
        @method('delete')
        @csrf
