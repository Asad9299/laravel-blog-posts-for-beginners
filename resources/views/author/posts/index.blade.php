...
<a href="{{ route('author.posts.create')}}" class="btn btn-success mb-2">Create New Post</a>
<div class="card">
        <div class="card-header fw-bold">List of posts</div>
        <div class="card-body">
    ...
    <tr>
      ...
      <td>
        <div class="d-flex gap-2">
          <a href="{{ route('author.posts.show', $post->id) }}" class="btn btn-secondary">
            <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 16 16" width="16" height="16" fill="currentColor">
  <path d="M8 1.5C3 1.5 0 8 0 8s3 6.5 8 6.5 8-4.5 8-6.5-3-6.5-8-6.5zM8 11c-2.2 0-4-1.8-4-3.5s1.8-3.5 4-3.5 4 1.8 4 3.5-1.8 3.5-4 3.5zm0-2c-1.1 0-2-.9-2-2s.9-2 2-2 2 .9 2 2-.9 2-2 2zM8 8c-.6 0-1 .4-1 1s.4 1 1 1 1-.4 1-1-.4-1-1-1z"/>
</svg>
          </a>
